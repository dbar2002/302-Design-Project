    ...
    return Scaffold(
      ...
      body: Column(
              children: [
                ...
                Row (
                  children: [
                    Checkbox( //need to change to store info once profile functionality is set up
                      value: this.student, 
                  ...
                  TextButton(onPressed: (){
                    if(student!) {
                      showSnackBar(context, 'Organization added with student access!');
                    }
                    if(visitor!) {
                      showSnackBar(context, 'Organization added with visitor access!');
                    }
                    if(employee!) {
                      showSnackBar(context, 'Organization added with employee access!');
                    }
